...
function sunshine_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  // If the default theme is either sunshine or socialsaas then extend
  // the form in the appearance section.
  if($system_theme_settings == 'sunshine' || $system_theme_settings == 'socialsaas') {
